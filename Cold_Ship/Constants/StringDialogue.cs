...
namespace Cold_Ship
{
    public static class StringDialogue
    {
        ...
        public static String generatorRoomComputerActivityLog12 = "Error code: 00101 '";                                                        //
        ...
        public static String controlRoomFinalSpeech4 = ". . .";                                                                                 //
        public static String controlRoomFinalSpeech5 = ". . .";                                                                                 //
        public static String controlRoomFinalSpeech6 = "I should say...";                                                                       //
        public static String controlRoomFinalSpeech7 = "...you'll probably live now.";                                                          //
        public static String controlRoomFinalSpeech8 = "You've figured it out, haven't you?";                                                   //
        public static String controlRoomFinalSpeech9 = "After all...";                                                                          //
        public static String controlRoomFinalSpeech10 = "...you've seen it...";                                                                 //
        public static String controlRoomFinalSpeech11 = "...there's no one else here.";                                                         //
        public static String controlRoomFinalSpeech12 = ". . .";                                                                                //
        public static String controlRoomFinalSpeech13 = ". . .";                                                                                //
        public static String controlRoomFinalSpeech14 = "You're alone.";                                                                        //
        public static String controlRoomFinalSpeech15 = "You've always been alone here.";                                                       //
        public static String controlRoomFinalSpeech16 = "Isn't that why you shut everything down in the first place?";                          //
        public static String controlRoomFinalSpeech17 = "Isn't that why you tried to forget?";                                                  //
        public static String controlRoomFinalSpeech18 = "You said you don't regret what you've done, but...";                                   //
        public static String controlRoomFinalSpeech19 = "...your actions speak differently";                                                    //
        public static String controlRoomFinalSpeech20 = ". . .";                                                                                //
        public static String controlRoomFinalSpeech21 = ". . .";                                                                                //                                                                                                                                        //
        public static String controlRoomFinalSpeech22 = "You remember now, I see.";                                                             //
        public static String controlRoomFinalSpeech23 = "Maybe that's not such a bad thing.";                                                   //
        public static String controlRoomFinalSpeech24 = "You wanted to live.";                                                                  //
        public static String controlRoomFinalSpeech25 = "And here you are.";                                                                    //
        public static String controlRoomFinalSpeech26 = "Remembering and atoning is just a part of that.";                                      //
        public static String controlRoomFinalSpeech27 = ". . .";                                                                                //
        public static String controlRoomFinalSpeech28 = ". . .";                                                                                //
        public static String controlRoomFinalSpeech29 = "...I think...";                                                                        //
        public static String controlRoomFinalSpeech30 = "...I'll be all right.";                                                                //
        public static String controlRoomFinalSpeech31 = "After all...";                                                                         //
        public static String controlRoomFinalSpeech32 = "...there's only about four years and 10 months to go.";                                //
        /****************************************************************************************************************************************/
    }
}
