...
namespace Cold_Ship
{
  public class Level_Prison_Block
  {
    ...
    public void LoadContent(ContentManager Content, Game_Level gameLevel, Game_Level prevGameLevel, double bodyTemperature, double stamina, double staminaLimit)
    {
      ...
      {
        playerNode = new Character(GameInstance, playerTexture, new Vector2(backwardDoor.Position.X + backwardDoor.size.X + 5, worldSize.Y - 64 - 50), bodyTemperature, stamina, staminaLimit, 4, 6);
      }
